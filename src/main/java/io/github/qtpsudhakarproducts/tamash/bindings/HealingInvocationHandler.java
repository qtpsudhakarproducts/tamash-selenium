 ...
 * {@code WebDriverWait} (the {@link io.github.qtpsudhakarproducts.tamash.healer.HealCache} keeps a
...
final class HealingInvocationHandler implements InvocationHandler {
  ...
  private static void pinImplicitWait(WebDriver driver) {
    String keep = io.github.qtpsudhakarproducts.tamash.Env.get("TAMASH_KEEP_IMPLICIT_WAIT");
  ...
  private Object doFindElement(By by) throws Throwable {
    ...
    try {
      ...
      if (inWait && !io.github.qtpsudhakarproducts.tamash.healer.HealCache.everHealed(by)
