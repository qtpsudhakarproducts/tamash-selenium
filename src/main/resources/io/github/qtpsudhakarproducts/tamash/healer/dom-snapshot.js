(function () {
  /* Injected by io.github.qtpsudhakarproducts.tamash.healer.DomSnapshot#capture.
     Walks the live DOM and returns a YAML accessibility tree in the exact shape
     DurableLocator#parseAriaAiTree parses. Every emitted element is stamped
     data-tamash-ref="eN" so an AI-picked [ref=eN] resolves back to a real node via
     By.cssSelector("[data-tamash-ref='eN']"). */
